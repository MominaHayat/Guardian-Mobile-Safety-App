...
import 'recording.dart'; // Import your Recording page file
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            IconButton(
              onPressed: () {
                // Navigate to the view statistics page.
            ...
            IconButton(
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => SafetySuggestionsPage()));
              },
              icon: const Icon(Icons.lightbulb, size: 30), // Use the microphone icon or choose an appropriate icon
            ),
          ],
        ),
      ),
